...
class EditChatDescription(Command[None]):
    chat_id: ChatId
    description: str | None


class EditChatDescriptionHandler(
    RequestHandler[EditChatDescription, None]
):
    def __init__(
        self,
    ...
    async def handle(self, request: EditChatDescription) -> None:
