...
class KickMember(Command[None]):
    chat_id: ChatId
    member_id: UserId


class KickMemberHandler(RequestHandler[KickMember, None]):
    def __init__(
        self,
    ...
    async def handle(self, request: KickMember) -> None:
