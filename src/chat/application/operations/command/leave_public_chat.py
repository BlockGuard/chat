...
class LeavePublicChat(Command[None]):
    chat_id: ChatId


class LeavePublicChatHandler(RequestHandler[LeavePublicChat, None]):
    def __init__(
        self,
    ...
    async def handle(self, request: LeavePublicChat) -> None:
