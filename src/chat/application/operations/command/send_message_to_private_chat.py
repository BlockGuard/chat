...
class SendMessageToPrivateChat(Command[MessageId]):
    chat_id: ChatId
    content: str


class SendMessageToPrivateChatHandler(
    RequestHandler[SendMessageToPrivateChat, MessageId]
):
    def __init__(
        self,
    ...
    async def handle(self, request: SendMessageToPrivateChat) -> MessageId:
        ...
        message = private_chat.send_message_to_private_chat(
