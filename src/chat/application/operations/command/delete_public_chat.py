...
class DeletePublicChat(Command[None]):
    chat_id: ChatId


class DeletePublicChatHandler(RequestHandler[DeletePublicChat, None]):
    def __init__(
        self,
    ...
    async def handle(self, request: DeletePublicChat) -> None:
