...
class KickPublicChatMember(Command[None]):
    member_id: UserId
    chat_id: ChatId


class KickPublicChatMemberHandler(RequestHandler[KickPublicChatMember, None]):
    def __init__(
        self,
    ...
    async def handle(self, request: KickPublicChatMember) -> None:
        ...
        public_chat.kick_member(
            kicked_by_id=current_user_id,
