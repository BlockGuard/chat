...
from chat.application.operations.command.change_public_chat_member_status import (
    ChangePublicChatMemberStatus,
)
from chat.domain.member.statuses import MemberStatus


class ChangePublicChatMemberStatusBehavior(
    PipelineBehavior[ChangePublicChatMemberStatus, None]
):
    async def handle(
        self,
        request: ChangePublicChatMemberStatus,
        handle_next: HandleNext[ChangePublicChatMemberStatus, None],
    ) -> None:
